...
{
    /// <summary>
    /// Computes the <see cref="T:CoiniumServ.Cryptology.Algorithms.SHA3" /> hash for the input data.
    /// </summary>
    [ComVisible(true)]
    public abstract class SHA3 : HashAlgorithm
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="T:CoiniumServ.Cryptology.Algorithms.SHA3" />.
        /// </summary>
        protected SHA3()
        {
        ...
        /// <summary>Creates an instance of the default implementation of <see cref="T:CoiniumServ.Cryptology.Algorithms.SHA3" />.</summary>
        /// <returns>A new instance of <see cref="T:CoiniumServ.Cryptology.Algorithms.SHA3" />.</returns>
        ...
        {
			return Create("CoiniumServ.Cryptology.Algorithms.SHA3");
        }

        /// <summary>Creates an instance of a specified implementation of <see cref="T:CoiniumServ.Cryptology.Algorithms.SHA3" />.</summary>
        /// <returns>A new instance of <see cref="T:CoiniumServ.Cryptology.Algorithms.SHA3" /> using the specified implementation.</returns>
        /// <param name="hashName">The name of the specific implementation of <see cref="T:CoiniumServ.Cryptology.Algorithms.SHA3" /> to be used. </param>
