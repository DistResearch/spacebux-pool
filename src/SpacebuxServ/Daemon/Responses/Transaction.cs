...
namespace SpacebuxServ.Daemon.Responses
{
    ...
    {
        [JsonConverter(typeof(EpDecimalConverter))]
        public decimal Amount { get; set; } // seems it's set to 0 for immature transactions or generation transactions.
        ...
        /// </summary>
        public decimal TotalAmount { get { return Details.Sum(item => item.Amount); } }
