...
namespace SpacebuxServ.Daemon.Responses
{
    ...
    public class BlockTemplate : IBlockTemplate
    {
        ...
        /// <summary>
        /// the account merkle tree root rash
        /// </summary>
        public string AccountRootHash { get; set; }
        ...
        /// </summary>
        public UInt64 Coinbasevalue { get; set; }
