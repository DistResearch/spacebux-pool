...
using SpacebuxServ.Daemon.Requests;
...
namespace SpacebuxServ.Daemon
{
    ...
    public class DaemonClient : DaemonBase, IDaemonClient
    {
        ...
        public BlockTemplate GetBlockTemplate()
        {
            ...
            var blockTemplate= MakeRequest<BlockTemplate>("getblocktemplate", capabilities);

            if (blockTemplate.CoinBaseAux == null)
                blockTemplate.CoinBaseAux = new CoinBaseAux();
        ...
        public BlockTemplate GetBlockTemplate(string blockHex)
        {
            ...
            var blockTemplate = MakeRequest<BlockTemplate>("getblocktemplate", submission);
