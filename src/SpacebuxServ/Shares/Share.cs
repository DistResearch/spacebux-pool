...
namespace SpacebuxServ.Shares
{
    ...
    public class Share : IShare
    {
        ...
        public UInt64 NTime { get; private set; }
		...
		public Hash CoinbaseTxId { get; private set; }
        public byte[] MerkleRoot { get; private set; }
        public byte[] HeaderBuffer { get; private set; }
        public byte[] HeaderBufferForHash { get; private set; }
        public byte[] HeaderHash { get; private set; }
        public BigInteger HeaderHashValue { get; private set; }
