...
namespace SpacebuxServ.Tests.Transactions
{
    public class OutputsTests
    {
        ...
        public void TestOutputs()
        {
            ...
            outputs.List.Last().PublicKeyScriptLength.Should().Equal(new byte[] { 0x19 });
            ...
            outputs.List.First().PublicKeyScriptLength.Should().Equal(new byte[] { 0x19 });
