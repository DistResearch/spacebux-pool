...
namespace SpacebuxServ.Tests.Shares
{
    public class ShareTests
    {
        ...
        public void CandicateShareTest()
        {
            ...
            share.HeaderHashValue.Should().Equal(BigInteger.Parse("587542370056468750648693126335067486740543774422516057325819970489306"));
        ...
        public void NonCandicateShareTest()
        {
            ...
            share.HeaderHashValue.Should().Equal(BigInteger.Parse("45620193236259201373579162993315268294283759910880625924204234612081027"));
